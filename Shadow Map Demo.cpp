...
void ShadowMapApp::initApp()
{
	...
	mFloorMapRV         = GetTextureMgr().createTex(L"..\\Textures\\Floor\\floor_diffuse.dds");
	mFloorNormalMapRV   = GetTextureMgr().createTex(L"..\\Textures\\Floor\\floor_normal.dds");
	...
	mBallMapRV          = GetTextureMgr().createTex(L"..\\Textures\\Default\\blackdiffuse.dds");
	mColumnMapRV        = GetTextureMgr().createTex(L"..\\Textures\\Brick\\bricks_diffuse.dds");
	mColumnNormalMapRV  = GetTextureMgr().createTex(L"..\\Textures\\Brick\\bricks_normal.dds");
